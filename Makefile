...
all: loom_create_table indy3_create_table maniac_create_table zak_create_table loom_decode indy3_decode maniac_decode zak_decode
...
clean:
	...
	rm -f indy3_decode.o loom_decode.o maniac_decode.o zak_decode.o indy3_create_table.o loom_create_table.o maniac_create_table.o zak_create_table.o

	rm -f indy3_decode loom_decode maniac_decode zak_decode
