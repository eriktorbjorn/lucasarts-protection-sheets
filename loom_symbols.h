#ifndef LOOM_SYMBOLS_H
#define LOOM_SYMBOLS_H
...
const char *html_preamble =
	...
	"<title>BOOK of PATTERNS</title>\n"
	"<style>\n"
	"table {\n"
	"    border-collapse: separate;\n"
	"    border-spacing: 60px 18px;\n"
	"}\n" 
	"th.thread {\n"
...
#define BEGIN_GUILD_SYMBOL(id) \
	"<symbol id=\"" id "\" viewbox=\"0 0 208 208\">\n" \
	"<circle cx=\"104\" cy=\"104\" r=\"101\" fill=\"white\" stroke=\"black\" stroke-width=\"3\" />\n"
#define END_GUILD_SYMBOL() "</symbol>\n"

#define BEGIN_SYMBOL(id) \
	"<symbol id=\"" id "\" viewbox=\"0 0 83 74\">\n" \
	"<rect x=\"1\" y=\"1\" width=\"81\" height=\"72\" fill=\"white\" stroke=\"black\" stroke-width=\"2\" />"
#define END_SYMBOL() "</symbol>\n"

// This is too much text to portably fit into one single string constant.

const char *svg_symbols[] = {
	"<svg style=\"display: none\">\n"
	"<defs>\n",

	BEGIN_GUILD_SYMBOL("G1")
	"<circle cx=\"104\" cy=\"79\" r=\"62\" fill=\"none\" stroke=\"black\" stroke-width=\"3\" />\n"
	"<path d=\"M 95 205 V 127 C 95 105, 74 95, 71 82 C 68 69, 71 63, 78 52 C 73 90, 98 95, 99 60 C 99 49, 98 46, 104 27 C 110 46, 109 49, 109 60 C 110 95, 135 90, 130 52 C 137 63, 140 69, 137 82 C 134 95, 113 105, 113 127 V 205\" fill=\"black\" stroke=\"black\" stroke-width=\"2\" stroke-linejoin=\"round\" />\n"
	END_GUILD_SYMBOL(),

	BEGIN_GUILD_SYMBOL("G2")
	"<g>\n"
	...
	"<path d=\"M 33 22.5 v 5.5 L 61 15.5 v -5.5 Z\" stroke=\"none\" fill=\"black\" />\n"
	END_SYMBOL(),
